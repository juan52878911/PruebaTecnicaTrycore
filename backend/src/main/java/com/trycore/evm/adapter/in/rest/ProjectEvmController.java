...
public class ProjectEvmController {
    ...
    @Operation(
            ...
            description = "Devuelve los indicadores de Valor Ganado consolidados del proyecto, calculados sobre "
                    + "la suma de BAC, PV, EV y AC de sus actividades, junto con los indicadores de cada actividad.")
    @ApiResponse(
            responseCode = "200",
    ...
    public ProjectEvmSummaryResponse analyze(@PathVariable final Long id) {
        return ProjectEvmSummaryRestMapper.toResponse(projectEvmUseCase.analyze(id));
    }
}
